...
const MyInquiries = () => {
      ...
      //to fetch the inquirty coming from server side
      useEffect(() => {
      ...
      //to mark as read for the inquiry for selleer
  ...
  return (
        <div className={user?.role !== "seller" ? s.bgBgAltMinH : s.bgTransparentHAuto}>
              {user?.role !== "seller" && <Navbar />}
              <div className={`${s.containerFadeIn} ${
              ...
              >
                    <div className={s.mb12}>
                          ...
                          <p className={s.textMuted}>
                                {isSeller ? 
                                      "Review and respond to interset in your poperties"
                    ...
                    {inquiries.length === 0 ? (
                          <div className={s.cardPremiumPy24Px8TextCenter}>
                                ...
                                <p className={s.textMutedMb8}>
                                      {isSeller ?
                                            "You havn't received any inquiries yet. Better listings get more attention!"
                                      : "You havn't contacted any seller yet. Intersted in a propert? send an inquiry!"}
                                </p>
                                            ...
                                            <div key={inq._id} className={s.inquiryCard}>
                                                  <div className={s.inquiryMain}>
                                                        ...
                                                        <div className={s.flex1}>
                                                              ...
                                                              {!isSeller && (
                                                                    <div className={s.flexItemsCenerGap2}>
