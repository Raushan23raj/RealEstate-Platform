...
export const landingPageStyles = {
      ...
      // Hero section
      heroSection:
            "fade-in items-center justify-center  hero-section pt-32 pb-16 xl:px-10 md:px-20 flex items-center gap-16 overflow-hidden md:flex-col lg:flex-col xl:flex-row max-lg:flex-col max-lg:text-center max-lg:pt-28 max-lg:pb-8 max-lg:px-4 max-lg:gap-8",
      heroContent:
      ...
      // Hero image
      heroImageContainer: "hero-image-container flex-1 relative mt-20",
      imageWrapper:
            "rounded-[3rem] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.25)] relative",
      heroImage: "w-full h-[400px] object-cover ",
      verifiedBadge:
      ...
      categoryCard:
            "category-card py-9 px-6 text-center cursor-pointer bg-white rounded-3xl border border-[#e2e8f0] transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] hover:-translate-y-2 hover:border-primary hover:shadow-[0_12px_25px_-5px_rgba(13,148,136,0.1)] group max-sm:py-6 max-sm:px-4",
      categoryIconWrapper:
      ...
      featuresContainer:
            "container features-container flex gap-12 items-center max-lg:flex-col max-lg:gap-10",
      featuresList:
            "features-list-container flex-1 grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6 max-md:grid-cols-1 max-md:gap-6",
      featureCard:
            "fade-in feature-card-item p-6 bg-white rounded-3xl border border-[#e2e8f0] transition-all duration-300 flex flex-col items-start hover:border-primary hover:-translate-y-[5px] hover:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05)]",
      featureIconWrapper:
            "w-12 h-12 bg-primary-light text-primary rounded-2xl flex items-center justify-center mb-4",
      featureTitle: "text-[1.05rem] mb-2 font-extrabold",
      featureDesc: "text-text-muted text-[0.875rem] leading-relaxed",
      featuresContent: "flex-1",
      featuresHeading: "text-[clamp(2rem,4vw,3.5rem)] font-extrabold mb-4",
      featuresSubtext: "text-text-muted text-[1.125rem] mb-8 leading-[1.8]",
      featuresListItems: "flex flex-col gap-4",
      listItem: "flex items-center gap-4 font-medium",
      learnMoreLink:
            "inline-block mt-8 text-primary font-semibold border-b-2 hover:text-primary-dark",
